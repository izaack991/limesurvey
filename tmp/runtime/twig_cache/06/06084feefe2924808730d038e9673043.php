...
class __TwigTemplate_49c9489e239077544a1f7df8f9982fb7 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 29
        if (((twig_get_attribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "active", [], "any", false, false, true, 29) != "Y") &&  !twig_get_attribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "popupPreview", [], "any", false, false, true, 29))) {
            // line 30
...
";
    ...
    {
        return new Source("", "./subviews/messages/warnings.twig", "C:\\xampp\\htdocs\\limesurvey\\themes\\survey\\fruity_twentythree\\views\\subviews\\messages\\warnings.twig");
    }
