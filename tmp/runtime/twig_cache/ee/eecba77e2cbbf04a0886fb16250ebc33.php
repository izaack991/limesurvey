...
class __TwigTemplate_4b1f41d1595e9a478a8a97aa604a3090 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "showsurveypolicynotice", [], "any", false, false, true, 6) == 2)) {
            // line 7
            echo "    ";
            $context["STARTPOLICYLINK"] = (("<a data-bs-target='#data-security-modal-" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "sid", [], "any", false, false, true, 7), 7, $this->source)) . "' class='show-policy' data-bs-toggle='modal'>");
            // line 8
            echo "    ";
...
";
    ...
    {
        return new Source("", "/subviews/privacy/privacy_datasecurity_notice_label.twig", "C:\\xampp\\htdocs\\limesurvey\\themes\\survey\\fruity_twentythree\\views\\subviews\\privacy\\privacy_datasecurity_notice_label.twig");
    }
