...
class __TwigTemplate_0bdfe20e2cbb2b574dd439afc7521783 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
            // line 28
            echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["C"] ?? null), "Html", [], "any", false, false, true, 28), "form", [twig_get_attribute($this->env, $this->source,             // line 29
...
";
    ...
    {
        return new Source("", "./subviews/navigation/language_changer_first_page.twig", "C:\\xampp\\htdocs\\limesurvey\\themes\\survey\\fruity_twentythree\\views\\subviews\\navigation\\language_changer_first_page.twig");
    }
