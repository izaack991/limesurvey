...
class __TwigTemplate_d615a78736d93cdb9e8b4845fadf92f8 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
    ...
    <div class=\"";
        ...
        // line 32
        echo "        ";
        if (( !twig_get_attribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "popupPreview", [], "any", false, false, true, 32) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["aNavigator"] ?? null), "aMovePrev", [], "any", false, false, true, 32), "show", [], "any", false, false, true, 32))) {
            // line 33
    ...
    <div class=\"";
        ...
        // line 42
        echo "        ";
        if (( !twig_get_attribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "popupPreview", [], "any", false, false, true, 42) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["aNavigator"] ?? null), "aMoveNext", [], "any", false, false, true, 42), "show", [], "any", false, false, true, 42))) {
            // line 43
            echo "
            ";
            // line 45
            echo "            ";
            if (( !twig_get_attribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "popupPreview", [], "any", false, false, true, 45) && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["aNavigator"] ?? null), "aMoveNext", [], "any", false, false, true, 45), "value", [], "any", false, false, true, 45) == "movesubmit"))) {
                // line 46
                echo "                ";
...
";
    ...
    {
        return new Source("", "./subviews/navigation/navigator.twig", "C:\\xampp\\htdocs\\limesurvey\\themes\\survey\\fruity_twentythree\\views\\subviews\\navigation\\navigator.twig");
    }
