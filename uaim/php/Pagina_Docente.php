...
<script>
    function mostrarContenido() {
        ...
        switch (tipoEncuesta) {
    case "seleccion_1":
        contenidoSeleccionado = "<form action='Redireccion.php' method='post'><div class='row mb-3 mx-1'><div class='input-group'><span class='input-group-text text-white fw-bold justify-content-center' style='background-color:#14ae5c;width:11rem;' for='docentea'>Auto Evaluacion</span><input type='hidden' name='tipo_encuesta' value='2'><select class='form-select' id='docentea' name='docentea'><option value=''>Seleccionar docente</option></select></div></div><div class='row justify-content-center'><button type='submit' id='enviar' class='btn btn-primary w-50'>Enviar</button></div></form>";
        break;
    case "seleccion_2":
        contenidoSeleccionado = "<form action='Redireccion.php' method='post'><div class='row mb-3 mx-1'><div class='input-group'><span class='input-group-text text-white fw-bold justify-content-center' style='background-color:#14ae5c;' for='docentec'>Evaluacion Docente Coordinador P.E</span><input type='hidden' name='tipo_encuesta' value='3'><select class='form-select' id='docentec' name='docentec'><option value=''>Seleccionar docente</option></select></div></div><div class='row justify-content-center'><button type='submit' id='enviar' class='btn btn-primary w-50'>Enviar</button></div></form>";
        break;
    case "seleccion_3":
        contenidoSeleccionado = "<form action='Redireccion.php' method='post'><div class='row mb-3 mx-1'><div class='input-group'><span class='input-group-text text-white fw-bold justify-content-center' style='background-color:#14ae5c;' for='docentejsa'>Evaluación Docente Jefe de Sección Académica</span><input type='hidden' name='tipo_encuesta' value='4'><select class='form-select' id='docentejsa'name='docentejsa'><option value=''>Seleccionar docente</option></select></div></div><div class='row justify-content-center'><button type='submit' id='enviar' class='btn btn-primary w-50'>Enviar</button></div></form>";
        break;
    case "seleccion_4":
        contenidoSeleccionado = "<form action='Redireccion.php' method='post'><div class='row mb-3 mx-1'><div class='input-group'><span class='input-group-text text-white fw-bold justify-content-center' style='background-color:#14ae5c;width:11rem;' for='docentep'>Evaluacion Pares</span><input type='hidden' name='tipo_encuesta' value='5'><select class='form-select' id='docentep'name='docentep'><option value=''>Seleccionar docente</option></select></div></div><div class='row justify-content-center'><button type='submit' id='enviar' class='btn btn-primary w-50'>Enviar</button></div></form>";
        break;
    default:
